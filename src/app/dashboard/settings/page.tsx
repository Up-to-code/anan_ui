...
import { FiUser, FiMail, FiPhone, FiLock, FiGlobe, FiBell, FiShield, FiLogOut, FiSave, FiEdit } from 'react-icons/fi';
                ...
                <div className="space-y-6">
                  ...
                  {isEditing && (
                    <div className="flex space-x-4 space-x-reverse pt-4">
                      <Button.Primary type="button" onClick={handleProfileSave} className="flex items-center space-x-2 space-x-reverse">
                        <FiSave size={16} />
                        <span>حفظ التغييرات</span>
                      </Button.Primary>
                      <Button.Secondary type="button" onClick={() => setIsEditing(false)}>
                        إلغاء
                      </Button.Secondary>
                    </div>
                  )}
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <Button.Primary type="button" onClick={handlePasswordSave} className="mt-4">
                        تغيير كلمة المرور
                      </Button.Primary>
                    </div>
                  </div>
                  ...
                  <div className="border-t border-gray-200 pt-6">
                    <h3 className="font-medium text-gray-900 mb-4">جلسات التسجيل</h3>
                    <div className="space-y-3">
                      <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                        <div>
                          <p className="font-medium text-gray-900">هذه الجلسة</p>
                          <p className="text-sm text-gray-600">متصفح Chrome على Windows</p>
                        </div>
                        <span className="text-sm text-green-600 bg-green-100 px-2 py-1 rounded">نشطة</span>
                      </div>
                      <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                        <div>
                          <p className="font-medium text-gray-900">جلسة سابقة</p>
                          <p className="text-sm text-gray-600">متصفح Safari على iPhone</p>
                        </div>
          ...
          {activeTab === 'notifications' && (
            <Card className="border border-gray-200">
              <CardContent className="p-6">
                ...
                <div className="space-y-6">
                  <div>
                    <h3 className="font-medium text-gray-900 mb-4">تفضيلات الإشعارات</h3>
                    <div className="space-y-4">
                        ...
                        <div key={key} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                          <div>
                            ...
                            <p className="text-sm text-gray-600">
                              {key === 'email' && 'استلام إشعارات على البريد الإلكتروني'}
                              {key === 'sms' && 'استلام إشعارات عبر رسائل SMS'}
                              {key === 'push' && 'استلام إشعارات فورية في المتصفح'}
                            </p>
                          </div>
                    ...
                    <Button.Primary type="button" onClick={handleNotificationsSave} className="mt-6">
                      حفظ التفضيلات
                    </Button.Primary>
                  </div>
                </div>
          ...
          {activeTab === 'preferences' && (
            <Card className="border border-gray-200">
              <CardContent className="p-6">
                ...
                <div className="space-y-6">
                  <div>
                    <h3 className="font-medium text-gray-900 mb-4">إعدادات اللغة</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <Input.Select
                        label="لغة الواجهة"
                  ...
                  <div className="border-t border-gray-200 pt-6">
                    <h3 className="font-medium text-gray-900 mb-4">إعدادات النظام</h3>
                    <div className="space-y-4">
                      <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <div>
                          <p className="font-medium text-gray-900">الوضع الليلي</p>
                          <p className="text-sm text-gray-600">تفعيل الوضع المظلم للواجهة</p>
                        </div>
                        <label className="relative inline-flex items-center cursor-pointer">
                          <input
                            type="checkbox"
                      ...
                      <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <div>
                          <p className="font-medium text-gray-900">التحديثات التلقائية</p>
                          <p className="text-sm text-gray-600">تثبيت التحديثات تلقائياً</p>
                        </div>
                        <label className="relative inline-flex items-center cursor-pointer">
                          <input
                            type="checkbox"
                            checked={userData.autoUpdate}
                            onChange={e => setUserData({ ...userData, autoUpdate: e.target.checked })}
                            className="sr-only peer"
                          />
                          <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:right-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                        </label>
                    ...
                    <Button.Primary type="button" onClick={handlePreferencesSave} className="mt-6">
                      حفظ الإعدادات
                    </Button.Primary>
                  </div>
                </div>
